      ...
      >
        ...
        <div className="mt-6 flex w-full gap-3">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isProcessing}
            className="flex-1 rounded-xl border-2 border-red-500 bg-red-500 px-5 py-3 text-sm font-bold text-white transition hover:bg-red-500/90 disabled:cursor-not-allowed disabled:opacity-60"
          >
